...
RANDOMIZED_TEST_CASE(one_of_fn)
{
    GEN(x, Gen::one_of(
        [](){return 1;},
        [](){return 2;}
...
RANDOMIZED_TEST_CASE(one_of_fn_arg)
{
    GEN(x, Gen::one_of(
        [](double a){return a;},
        [](double a){return a+1;}
...
RANDOMIZED_TEST_CASE(frequency_fn)
{
    GEN(x, Gen::frequency(
        Gen::Choice { 5, [](){return 1;} },
        Gen::Choice { 1, [](){return 2;} }
    ));
    ASSUME(x == 1);
    EXPECT(x == 1);
}
...
// TODO RANDOMIZED_TEST_CASE number_u32
